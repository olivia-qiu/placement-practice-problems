...
public class TestHelpers {
    ...
    public static List<Integer> getIntegerListFromFile(Scanner scanner, int num_values, String filename) {
        ...
        if (data.size() != num_values) {
            ...
            System.out.println("  Expected: " + data.size());
            System.out.println("  Actual: " + num_values);
            System.exit(1);
        }
    ...
    /**
     * getString2IntMapping: load a string to integer mapping from
     * a file.
     **/
    public static Map<String, Integer> getStrToIntMapResult(File inputFile) {
        String l = "";
        ...
        try {
            ...
            System.out.println("Format error: line " + l);
            return null;
        } catch (Exception e) {
